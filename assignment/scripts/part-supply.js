...
console.log('The following numbers are:',supplyChanges);
...
console.log('Second item in supplyChanges:',secondItem);
...
console.log('Removed Last number',supplyChanges);
...
console.log('Added 25 into supplyChanges:',supplyChanges);
...
// let totalParts = 0;
// for (let supplyChanges = 0; i < array.length; i++) {
